...
class EditProfileForm(FlaskForm):
    ...
    about_me = TextAreaField(u'个性签名', validators=[Length(0, 128)], render_kw={'rows': 2, 'placeholder': u'一句话来展示自己'})
    submit = SubmitField(u'提交')
...
class NewArticleFrom(FlaskForm):
    ...
    body = PageDownField(u'内容', validators=[DataRequired(u'文章不能没有内容哦')],
                         render_kw={'rows': 14, 'placeholder': u'支持markdown写作，了解更多markdown语法，请点击底部写作帮助'})
    submit = SubmitField(u'提交')
